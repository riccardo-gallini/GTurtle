...
namespace GTurtle
{
    ...
    {
        [Export] public static MenuDefinition DebugMenu = new MenuDefinition(MenuDefinitions.MainMenuBar, 10, "Debug");
        ...
        [Export] public static ToolBarDefinition DebugToolbar = new ToolBarDefinition(10, "DEBUG");
        [Export] public static ToolBarItemGroupDefinition DebugToolbarGroup = new ToolBarItemGroupDefinition(DebugToolbar, 10);
        [Export] public static ToolBarItemDefinition PlayToolBarItem = new CommandToolBarItemDefinition<Play>(DebugToolbarGroup, 10, ToolBarItemDisplay.IconAndText);
